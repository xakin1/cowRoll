defmodule CowRoll.ScripsDndTest do
  ...
  describe "priority" do
    ...
    test "general priority" do
      result =
        eval_input("((3 + 5 * 2)  / 2^3 + 9%17 == 1 and 6 - 2 >= 3) or not (5 > 7)")
  ...
  describe "checking types" do
    ...
    test "check numeric expression with unitary -" do
      assert_raise(
        TypeError,
        "Error at line 1 in '-' operation, Incompatible type: Boolean was found but Integer was expected",
        fn ->
          eval_input("-true")
        end
      )
    ...
    test "check boolean expression with ++" do
      ...
      assert_raise(
        TypeError,
        "Error at line 1 in '++' operation, Incompatible types: Integer, String were found but String, String were expected",
        fn ->
          eval_input("3 ++ '2'")
        end
      )
  ...
  describe "ifs" do
    test "should return 6" do
      result = eval_input("if true then 2+4 end")

      assert result == 6
    end

    test "should return 0" do
      result = eval_input("if false then 2+4 else 0 end")

      assert result == 0
    end

    test "nested if should return 6" do
      result = eval_input("if true then if true then 2+4 else 3 end else 2 end")

      assert result == 6
    end

    test "nested else should return 1" do
      result = eval_input("if false then 2+4 else if false then 0 else 1 end end")
    ...
    test "test if with boolean operation" do
      result = eval_input("if (5 == 1) then true else false end")
      assert false == result
      result = eval_input("if (5 > 1) then true else false end")
      assert true == result
      result = eval_input("if (6*(5 - 5) > 1) then true else false end")
      assert false == result
    end
  ...
  describe "list" do
    ...
    test "array with two elements" do
      result = eval_input("[1,2]")
      assert result == [1, 2]
    end

    test "array with n elements" do
      result = eval_input("[1,2,3,3]")
  ...
  describe "variables" do
    ...
    test "overwrite the value of a variable" do
      result = eval_input("x=6; x=7")
      assert result == 7
    end

    test "Initialize two vars with one value" do
      result = eval_input("x=y=7
      x==7 and y == 7")
      assert result == true
    end
    ...
    test "using vars in operations changing values" do
      result = eval_input("x= 6; y = x + 2; x = x +2; z = x+y")
      assert result == 16
    end

    test "using vars with strings" do
      result = eval_input("x= \"hola mundo\" ")
      assert result == "hola mundo"
    end

    test "test plus with variables" do
      result = eval_input("x = 6;x + 5")
      assert 6 + 5 == result
    end
  ...
  describe "pow" do
    ...
    test "concat pows" do
      input = "2^2^2^2"
      result = eval_input(input)
      expect = Integer.pow(2, Integer.pow(2, Integer.pow(2, 2)))

      assert expect == result
    end

    test "pows with operations" do
      input = "(3+2)^2"
      result = eval_input(input)
      expect = Integer.pow(3 + 2, 2)
  ...
  describe "boolean operations" do
    ...
    test "less_equal with expression should return true" do
      for _ <- 1..100 do
        result = eval_input("5 <= (4 + 2)")
        assert true == result
      end
    end

    test "test equal" do
      result = eval_input("4 == 5")
      assert 4 == 5 == result
    end

    test "test equal n factors" do
      result = eval_input("4 == 5 == 6")
      assert 4 == 5 == 6 == result

      result = eval_input("5 == 5 == 5")
      assert 5 == 5 == 5 == result
    end

    test "test equal with differents types" do
      result = eval_input("false == 'false'")
      expect = false == "false"
      assert expect == result

      result = eval_input("false == 5")
      expect = false == "false"
      assert expect == result
    end

    test "test and" do
      result = eval_input("false and false")
      expect = false and false
      assert expect == result

      result = eval_input("false and true")
      expect = false and true
      assert expect == result

      result = eval_input("true and false")
      expect = true and false
      assert expect == result

      result = eval_input("true and true")
      expect = true and true
      assert expect == result
    end

    test "test and with n factors" do
      result = eval_input("false and false and false")
      expect = false and false and false
      assert expect == result

      result = eval_input("false and true and false")
      expect = true and false and false
      assert expect == result

      result = eval_input("true and false and false")
      expect = false and true and false
      assert expect == result

      result = eval_input("true and true and true")
      expect = true and true and true
      assert expect == result
    end

    test "test or" do
      result = eval_input("false or false")
      expect = false or false
      assert expect == result

      result = eval_input("false or true")
      expect = false or true
      assert expect == result

      result = eval_input("true or false")
      expect = true or false
      assert expect == result

      result = eval_input("true or true")
      expect = true and true
      assert expect == result
    end

    test "test or with multiple operators" do
      result = eval_input("false or false or true")
      expect = false or false or true
      assert expect == result
    end

    test "test not" do
      result = eval_input("not false")
      assert true == result
    end

    test "test concat nots" do
      result = eval_input(" not not false")
      expect = not not false
      assert expect == result
    end

    test "test not with operation" do
      result = eval_input("not (false or true)")
      assert false == result

      result = eval_input("not (true == (5<6))")
      expect = not (true == 5 < 6)
      assert expect == result
    end

    test "test not equal" do
      result = eval_input("true != 6")
      assert true == result

      result = eval_input("true != true")
      assert false == result

      result = eval_input("true != (5<6)")
      assert false == result
    end

    test "test compare" do
      result = eval_input("true > false")
      expect = true > false
      assert expect == result
      ...
      result = eval_input("5 > 6")
      expect = 5 > 6
      assert expect == result

      result = eval_input("5 > 5")
      expect = 5 > 5
      assert expect == result
