...
yystate(66, [94|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(69, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(66, [93|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(67, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(66, [92|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(68, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(66, [91|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(66, [35|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(68, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(66, [33|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(66, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 0, C =< 8 ->
    yystate(68, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(66, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11, C =< 31 ->
    yystate(68, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(66, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(34, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(66, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 98, C =< 122 ->
    yystate(34, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(62, [104|Ics], Line, Col, Tlen, _, _) ->
    yystate(46, Ics, Line, Col, Tlen+1, 37, Tlen);
...
yystate(62, [C|Ics], Line, Col, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(34, Ics, Line, Col, Tlen+1, 37, Tlen);
yystate(62, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(34, Ics, Line, Col, Tlen+1, 37, Tlen);
yystate(62, [C|Ics], Line, Col, Tlen, _, _) when C >= 105, C =< 113 ->
    yystate(34, Ics, Line, Col, Tlen+1, 37, Tlen);
yystate(62, [C|Ics], Line, Col, Tlen, _, _) when C >= 115, C =< 122 ->
    yystate(34, Ics, Line, Col, Tlen+1, 37, Tlen);
yystate(62, Ics, Line, Col, Tlen, _, _) ->
    {37,Tlen,Ics,Line,Col,62};
yystate(61, [100|Ics], Line, Col, Tlen, _, _) ->
    yystate(65, Ics, Line, Col, Tlen+1, 37, Tlen);
...
yystate(59, [61|Ics], Line, Col, Tlen, _, _) ->
    yystate(55, Ics, Line, Col, Tlen+1, 27, Tlen);
yystate(59, Ics, Line, Col, Tlen, _, _) ->
    {27,Tlen,Ics,Line,Col,59};
...
yystate(58, Ics, Line, Col, Tlen, _, _) ->
    {37,Tlen,Ics,Line,Col,58};
yystate(57, [110|Ics], Line, Col, Tlen, _, _) ->
    yystate(61, Ics, Line, Col, Tlen+1, 37, Tlen);
...
yystate(52, [92|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(44, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(52, [34|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(49, [111|Ics], Line, Col, Tlen, _, _) ->
    yystate(53, Ics, Line, Col, Tlen+1, 37, Tlen);
...
yystate(45, [95|Ics], Line, Col, Tlen, _, _) ->
    yystate(34, Ics, Line, Col, Tlen+1, 21, Tlen);
...
yystate(43, Ics, Line, Col, Tlen, _, _) ->
    {29,Tlen,Ics,Line,Col,43};
yystate(42, [110|Ics], Line, Col, Tlen, _, _) ->
    yystate(38, Ics, Line, Col, Tlen+1, 37, Tlen);
...
yystate(42, Ics, Line, Col, Tlen, _, _) ->
    {37,Tlen,Ics,Line,Col,42};
yystate(41, [101|Ics], Line, Col, Tlen, _, _) ->
    yystate(45, Ics, Line, Col, Tlen+1, 37, Tlen);
...
yystate(33, Ics, Line, Col, Tlen, _, _) ->
    {35,Tlen,Ics,Line,Col,33};
yystate(32, [95|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(28, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(32, [92|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(28, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(32, [39|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(48, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(32, [32|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(32, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(32, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 44, C =< 57 ->
    yystate(28, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(32, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(28, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(30, [114|Ics], Line, Col, Tlen, _, _) ->
    yystate(26, Ics, Line, Col, Tlen+1, 37, Tlen);
...
yystate(30, Ics, Line, Col, Tlen, _, _) ->
    {37,Tlen,Ics,Line,Col,30};
yystate(29, [100|Ics], Line, Col, Tlen, _, _) ->
    yystate(33, Ics, Line, Col, Tlen+1, 37, Tlen);
...
yystate(28, [95|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(28, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(28, [92|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(28, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(28, [39|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(48, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(28, [32|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(28, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 44, C =< 57 ->
    yystate(28, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(25, [108|Ics], Line, Col, Tlen, _, _) ->
    yystate(37, Ics, Line, Col, Tlen+1, 37, Tlen);
...
yystate(21, Ics, Line, Col, Tlen, _, _) ->
    {23,Tlen,Ics,Line,Col,21};
yystate(20, Ics, Line, Col, Tlen, _, _) ->
    {5,Tlen,Ics,Line,Col};
yystate(19, [100|Ics], Line, Col, Tlen, _, _) ->
    yystate(27, Ics, Line, Col, Tlen+1, 3, Tlen);
yystate(19, [C|Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(19, Ics, Line, Col, Tlen+1, 3, Tlen);
yystate(19, Ics, Line, Col, Tlen, _, _) ->
    {3,Tlen,Ics,Line,Col,19};
yystate(18, [116|Ics], Line, Col, Tlen, _, _) ->
    yystate(14, Ics, Line, Col, Tlen+1, 37, Tlen);
...
yystate(17, [101|Ics], Line, Col, Tlen, _, _) ->
    yystate(21, Ics, Line, Col, Tlen+1, 37, Tlen);
...
yystate(13, [115|Ics], Line, Col, Tlen, _, _) ->
    yystate(17, Ics, Line, Col, Tlen+1, 37, Tlen);
...
yystate(13, [C|Ics], Line, Col, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(34, Ics, Line, Col, Tlen+1, 37, Tlen);
yystate(13, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 114 ->
    yystate(34, Ics, Line, Col, Tlen+1, 37, Tlen);
yystate(13, [C|Ics], Line, Col, Tlen, _, _) when C >= 116, C =< 122 ->
    yystate(34, Ics, Line, Col, Tlen+1, 37, Tlen);
yystate(13, Ics, Line, Col, Tlen, _, _) ->
    {37,Tlen,Ics,Line,Col,13};
yystate(12, Ics, Line, Col, Tlen, _, _) ->
    {11,Tlen,Ics,Line,Col};
yystate(11, Ics, Line, Col, Tlen, _, _) ->
    {12,Tlen,Ics,Line,Col};
yystate(10, [102|Ics], Line, Col, Tlen, _, _) ->
    yystate(6, Ics, Line, Col, Tlen+1, 37, Tlen);
...
yystate(10, [C|Ics], Line, Col, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(34, Ics, Line, Col, Tlen+1, 37, Tlen);
yystate(10, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 101 ->
    yystate(34, Ics, Line, Col, Tlen+1, 37, Tlen);
yystate(10, [C|Ics], Line, Col, Tlen, _, _) when C >= 103, C =< 122 ->
    yystate(34, Ics, Line, Col, Tlen+1, 37, Tlen);
yystate(10, Ics, Line, Col, Tlen, _, _) ->
    {37,Tlen,Ics,Line,Col,10};
yystate(9, [108|Ics], Line, Col, Tlen, _, _) ->
    yystate(13, Ics, Line, Col, Tlen+1, 37, Tlen);
...
yystate(6, [95|Ics], Line, Col, Tlen, _, _) ->
    yystate(34, Ics, Line, Col, Tlen+1, 19, Tlen);
...
yystate(2, [C|Ics], Line, Col, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(34, Ics, Line, Col, Tlen+1, 37, Tlen);
yystate(2, [C|Ics], Line, Col, Tlen, _, _) when C >= 98, C =< 110 ->
    yystate(34, Ics, Line, Col, Tlen+1, 37, Tlen);
yystate(2, [C|Ics], Line, Col, Tlen, _, _) when C >= 112, C =< 122 ->
    yystate(34, Ics, Line, Col, Tlen+1, 37, Tlen);
yystate(2, Ics, Line, Col, Tlen, _, _) ->
    {37,Tlen,Ics,Line,Col,2};
yystate(1, [114|Ics], Line, Col, Tlen, _, _) ->
    yystate(5, Ics, Line, Col, Tlen+1, 37, Tlen);
...
yystate(1, [C|Ics], Line, Col, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(34, Ics, Line, Col, Tlen+1, 37, Tlen);
yystate(1, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 113 ->
    yystate(34, Ics, Line, Col, Tlen+1, 37, Tlen);
yystate(1, [C|Ics], Line, Col, Tlen, _, _) when C >= 115, C =< 122 ->
    yystate(34, Ics, Line, Col, Tlen+1, 37, Tlen);
yystate(1, Ics, Line, Col, Tlen, _, _) ->
    {37,Tlen,Ics,Line,Col,1};
